...
func (*CustomObject) ElementType() reflect.Type {
	return reflect.TypeOf((**CustomObject)(nil)).Elem()
}
...
func (CustomObjectMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*CustomObject)(nil)).Elem()
}
...
func (o CustomObjectOutput) Container() pulumi.StringOutput {
	return o.ApplyT(func(v *CustomObject) pulumi.StringOutput { return v.Container }).(pulumi.StringOutput)
}

// String matching the pattern '[-_~.a-zA-Z0-9]+'
func (o CustomObjectOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *CustomObject) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}

// JSON types Number, String, Boolean, Array, Object
func (o CustomObjectOutput) Value() pulumi.StringOutput {
	return o.ApplyT(func(v *CustomObject) pulumi.StringOutput { return v.Value }).(pulumi.StringOutput)
}

func (o CustomObjectOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v *CustomObject) pulumi.IntOutput { return v.Version }).(pulumi.IntOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*CustomObjectInput)(nil)).Elem(), &CustomObject{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomObjectArrayInput)(nil)).Elem(), CustomObjectArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*CustomObjectMapInput)(nil)).Elem(), CustomObjectMap{})
