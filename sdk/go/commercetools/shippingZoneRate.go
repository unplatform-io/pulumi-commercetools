...
func (*ShippingZoneRate) ElementType() reflect.Type {
	return reflect.TypeOf((**ShippingZoneRate)(nil)).Elem()
}
...
func (ShippingZoneRateMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*ShippingZoneRate)(nil)).Elem()
}
...
// The shipping is free if the sum of the (custom) line item prices reaches the freeAbove value
func (o ShippingZoneRateOutput) FreeAbove() ShippingZoneRateFreeAbovePtrOutput {
	return o.ApplyT(func(v *ShippingZoneRate) ShippingZoneRateFreeAbovePtrOutput { return v.FreeAbove }).(ShippingZoneRateFreeAbovePtrOutput)
}

func (o ShippingZoneRateOutput) Price() ShippingZoneRatePriceOutput {
	return o.ApplyT(func(v *ShippingZoneRate) ShippingZoneRatePriceOutput { return v.Price }).(ShippingZoneRatePriceOutput)
}

func (o ShippingZoneRateOutput) ShippingMethodId() pulumi.StringOutput {
	return o.ApplyT(func(v *ShippingZoneRate) pulumi.StringOutput { return v.ShippingMethodId }).(pulumi.StringOutput)
}

// A price tier is selected instead of the default price when a certain threshold or specific cart value is reached. If no
// tiered price is suitable for the cart, the base price of the shipping rate is used . See also [Shipping Rate Price Tier
// API Docs](https://docs.commercetools.com/api/projects/shippingMethods#shippingratepricetier)
func (o ShippingZoneRateOutput) ShippingRatePriceTiers() ShippingZoneRateShippingRatePriceTierArrayOutput {
	return o.ApplyT(func(v *ShippingZoneRate) ShippingZoneRateShippingRatePriceTierArrayOutput {
		return v.ShippingRatePriceTiers
	}).(ShippingZoneRateShippingRatePriceTierArrayOutput)
}

func (o ShippingZoneRateOutput) ShippingZoneId() pulumi.StringOutput {
	return o.ApplyT(func(v *ShippingZoneRate) pulumi.StringOutput { return v.ShippingZoneId }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingZoneRateInput)(nil)).Elem(), &ShippingZoneRate{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingZoneRateArrayInput)(nil)).Elem(), ShippingZoneRateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*ShippingZoneRateMapInput)(nil)).Elem(), ShippingZoneRateMap{})
