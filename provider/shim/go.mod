module github.com/labd/terraform-provider-commercetools/shim
...
require (
	...
	github.com/labd/terraform-provider-commercetools v1.7.1
)
...
require (
	...
	github.com/labd/commercetools-go-sdk v1.4.0 // indirect
...
replace github.com/labd/terraform-provider-commercetools => ../../upstream
