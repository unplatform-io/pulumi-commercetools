...
replace (
	...
	github.com/labd/terraform-provider-commercetools => ../upstream
	github.com/labd/terraform-provider-commercetools/shim => ./shim
)
...
require (
	...
	github.com/labd/terraform-provider-commercetools v1.7.1 // indirect
